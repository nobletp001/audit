...
import {  pagetwoZF1Action } from '../../Store/AuditSlice';
Icon.loadFont();
...
export default function PageTwoZF1({ navigation }) {
        ...
        <>
            ...
            <TouchableOpacity style={styles.arrowNext}>
                <Icon
                    ...
                    type="MaterialCommunityIcons"
                    iconStyle={{}}
                    onPress={() => navigation.navigate('pagetwozf2')}
                />
            </TouchableOpacity>
