...
import {  pagetwoZF6Action } from '../../Store/AuditSlice';
Icon.loadFont();
...
export default function PageTwoZF6({ navigation }) {
        ...
        <>
            ...
            <TouchableOpacity style={styles.arrowNext}>
                <Icon
                    ...
                    type="MaterialCommunityIcons"
                    iconStyle={{}}
                    onPress={() => navigation.navigate('pagetwozf7')}
                />
            </TouchableOpacity>
