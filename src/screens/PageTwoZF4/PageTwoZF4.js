...
import {  pagetwoZF4Action } from '../../Store/AuditSlice';
...
export default function PageTwoZF4({ navigation }) {
        ...
        <>
            ...
            <TouchableOpacity style={styles.arrowNext}>
                <Icon
                    ...
                    color="#214d77"
                    iconStyle={{}}
                    onPress={() => navigation.navigate('pagetwozf5')}
                />
            </TouchableOpacity>
            <Modal
                animationType="slide"
