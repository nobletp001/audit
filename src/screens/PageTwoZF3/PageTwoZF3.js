...
import {  pagetwoZF3Action } from '../../Store/AuditSlice';
...
export default function PageTwoZF3({ navigation }) {
        ...
        <>
            ...
            <TouchableOpacity style={styles.arrowNext}>
                <Icon
                    ...
                    color="#214d77"
                    iconStyle={{}}
                    onPress={() => navigation.navigate('pagetwozf4')}
                />
            </TouchableOpacity>
            <Modal
                animationType="slide"
