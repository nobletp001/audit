...
import {  pagetwoZF7Action } from '../../Store/AuditSlice';
Icon.loadFont();
...
export default function PageTwoZF7({ navigation }) {
        ...
        <>
            ...
            <TouchableOpacity style={styles.arrowNext}>
                <Icon
                    ...
                    type="MaterialCommunityIcons"
                    iconStyle={{}}
                    onPress={() => navigation.navigate('pagetwozf8')}
                />
            </TouchableOpacity>
