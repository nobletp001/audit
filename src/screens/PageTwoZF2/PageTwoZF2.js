...
import {  pagetwoZF2Action } from '../../Store/AuditSlice';
...
export default function PageTwoZF2({ navigation }) {
        ...
        <>
            ...
            <TouchableOpacity style={styles.arrowNext}>
                <Icon
                    ...
                    color="#214d77"
                    iconStyle={{}}
                    onPress={() => navigation.navigate('pagetwozf3')}
                />
            </TouchableOpacity>
            <Modal
                animationType="slide"
