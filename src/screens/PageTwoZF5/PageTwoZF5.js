...
import {  pagetwoZF5Action } from '../../Store/AuditSlice';
...
export default function PageTwoZF5({ navigation }) {
        ...
        <>
            ...
            <TouchableOpacity style={styles.arrowNext}>
                <Icon
                    ...
                    color="#214d77"
                    iconStyle={{}}
                    onPress={() => navigation.navigate('pagetwozf6')}
                />
            </TouchableOpacity>
